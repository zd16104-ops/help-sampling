...
final class Task {
    ...
    String riskBo() { return j.optString("risk_note_bo", ""); }
    ...
    String statusLabel() { return submitted() ? "已采样" : status().equals("in_progress") ? "采样中" : "待采样"; }
    String statusBo() { return submitted() ? "དཔེ་ཚད་བླངས་ཟིན།" : status().equals("in_progress") ? "ལས་ཀ་བྱེད་བཞིན་པ།" : "དཔེ་ཚད་ལེན་རྒྱུ།"; }
