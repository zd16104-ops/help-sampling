...
final class Util {
  ...
  static String type(String code){ switch(code){case"R":return"河流";case"T":return"支流";case"S":return"土壤";case"P":return"植物";case"Y":return"雨水";case"L":return"湖水";case"G":return"地下水";default:return code;} }
}
